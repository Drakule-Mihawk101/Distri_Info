...
public:
	...
	Node(int id, double size, int module, bool isModule,
	...
	void setOrigModule(Module* origMod) {
		orig_module = origMod;
	}
	...
	void setTeleportWeight(double tpweight) {
	...
	void setDanglingSize(double dSize) {
		danglingSize = dSize;
	}
	...
	void setIsDangling(bool dangle) {
		isDangling = dangle;
	}
